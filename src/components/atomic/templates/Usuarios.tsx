...
import type { ActionType } from "../organisms/UsuariosTable";
  ...
  const usuariosData = [
    {
      ...
      area: "Sistemas",
      permisos: 12,
      acciones: ["Permisos", "Editar", "Eliminar"] as ActionType[],
    },
    {
    ...
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6 p-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <CustomModal
            content={<CreateUser modulos={modulos}></CreateUser>}
            title="Crear Usuario"
...
<div className="p-6"><CustomTableUser titulo="Usuarios del sistema" data={usuariosData} /></div>
    </>
  );
};
