...
import { EyeIcon, CheckIcon, XIcon, Clock} from "lucide-react";
...
type SolicitudesPendProps = {
  titulo: string;
  data: (string | number)[][];
};

export default function SolicitudesPend({
  titulo,
  data,
}: SolicitudesPendProps) {
  const columns = [
    "ID",
    "Usuario",
    "Producto",
